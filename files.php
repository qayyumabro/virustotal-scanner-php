<?php 
include('config.php'); 
//Check user logged in or not, redirect if not
...
$sql = "SELECT COUNT(id) as total_pages FROM {$tbl_prefex}files";
...
<html lang="en">
<head>
  <title>Files  - <?php echo $baseTitle; ?></title>
  <meta charset="utf-8">
          ...
          <tr>
            ...
            <th style="width: 200px;">Delete</th>
              ...
              <?php  
                ...
                ORDER BY t1.id DESC LIMIT $start, $limit";
                $query = $handler->prepare($sql);
                $query->execute();
                $rows = $query->rowCount();
                if($rows > 0)
                  ...
                  while ($row=$query->fetch()) 
                  {
                    ...
                    <tr>
                      ...
                      <?php } 
                                ...
                                else if($status == "Queued") echo "<td><p><i class='fa fa-flag'></i> File queued for scan ".$helper->ago(strtotime($lastscantime)).".</p></td>";
                                else { echo "<td>-</td>"; }
                      ?>
                ...
                {
                  echo '<div class="col-md-12 text-center"><p>No files uploaded.</p></div>';
                }
            ...
            */
            ...
            { 
              ...
              //previous button
              if ($page > 1) 
                $pagination.= "<li class='page-item'><a class='page-link' href=\"$baseUrl/files.php?page=$prev\">←</a></li>";
              else
              ...
              { 
                for ($counter = 1; $counter <= $lastpage; $counter++)
                {
                  if ($counter == $page)
                    ...
                    $pagination.= "<li class='page-item'><a class='page-link' href=\"$baseUrl/files.php?page=$counter\">$counter</a></li>";
              ...
              elseif($lastpage > 5 + ($adjacents * 2))  //enough pages to hide some
              {
                ...
                if($page < 1 + ($adjacents * 2))    
                {
                  ...
                  $pagination.= "<li class='page-item disabled'><a class='page-link'>...</a></li>";
                  $pagination.= "<li class='page-item'><a class='page-link' href=\"$baseUrl/files.php?page=$lpm1\">$lpm1</a></li>";
                  $pagination.= "<li class='page-item'><a class='page-link' href=\"$baseUrl/files.php?page=$lastpage\">$lastpage</a></li>";   
                }
                //in middle; hide some front and some back
                elseif($lastpage - ($adjacents * 2) > $page && $page > ($adjacents * 2))
                {
                  $pagination.= "<li class='page-item'><a class='page-link' href=\"$baseUrl/files.php?page=1\">1</a></li>";
                  $pagination.= "<li class='page-item'><a class='page-link' href=\"$baseUrl/files.php?page=2\">2</a></li>";
                  $pagination.= "<li class='page-item disabled'><a class='page-link'>...</a></li>";
              ...
              //next button
              if ($page < $counter - 1) 
                $pagination.= "<li class='page-item'><a class='page-link' href=\"$baseUrl/files.php?page=$next\">→</a></li>";
              else
